module github.com/jaym/go-orleans/sample
...
require (
	...
	github.com/golang-migrate/migrate/v4 v4.15.1-0.20211015165204-1ba9becc5c8d // indirect
...
replace github.com/jaym/go-orleans => ../
